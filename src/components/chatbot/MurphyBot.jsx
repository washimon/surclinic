...
const Murphybot = () => {
    ...
    useEffect(() => {
        const chatInverval = window.setInterval(function() {
            const elem = document.getElementsByClassName('react-chatbot-kit-chat-container');
        ...
        return () => window.clearInterval(chatInverval);
    }, []);
